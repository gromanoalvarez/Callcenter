...
public class TestContactos {
	...
	public void queLosDatosDelContactoSeGuardenCorrectamente() {
		...
		//Ejecucion
		nuevo = new Contacto(NOMBRE_Y_APELLIDO_ESPERADO,CELULAR_ESPERADO,E_MAIL_ESPEPERADO,DIRECCION_ESPERADA,CODIGO_POSTAL_ESPERADO,LOCALIDAD_ESPERADA,PROVINCIA_ESPERADA);
	...
	/*
	 * queLaDireccionSeaAlfanumerica
	 * queElCodigoPostalSeaNumerico
	 * queLaLocalidadSeaAlfanumerico
	 * queProvinciaContenga23
	 * queClienteSeInicieEnFalse
	 * queDeseaSerLlamadoNuevamenteSeaTrue
	 * */
	...
	/* queSePuedaBuscarAlCandidato
	 * queSeMuestreEnPantallaLosDatosDelCandidato
	 * queParaLlamarElContactoNoSeaCliente
	 * queParaLlamarElContactoDeseaSerLlamado
